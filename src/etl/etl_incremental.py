...
def ejecutar_etl_incremental() -> bool:
    ...
    try:
        ...
        for row in o.fetchall():
            ...
            existe = d.fetchone()
            if existe:
                d.execute("""UPDATE HechoProyecto SET id_cliente=%s,id_empleado_gerente=%s,id_tiempo_fin_real=%s,presupuesto=%s,costo_real_proy=%s,variacion_costos=%s,cumplimiento_presupuesto=%s,duracion_planificada=%s,duracion_real=%s,variacion_cronograma=%s,cumplimiento_tiempo=%s,tareas_total=%s,tareas_completadas=%s,tareas_canceladas=%s,horas_plan_total=%s,horas_reales_total=%s,variacion_horas=%s,cambios_equipo_proy=%s WHERE id_proyecto=%s""",
                ...
                d.execute("""INSERT INTO HechoProyecto (id_proyecto,id_cliente,id_empleado_gerente,id_tiempo_fin_real,presupuesto,costo_real_proy,variacion_costos,cumplimiento_presupuesto,duracion_planificada,duracion_real,variacion_cronograma,cumplimiento_tiempo,tareas_total,tareas_completadas,tareas_canceladas,horas_plan_total,horas_reales_total,variacion_horas,cambios_equipo_proy) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)""",
